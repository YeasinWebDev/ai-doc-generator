...
export declare const getRepositoryInfo: (username: string, repo: string) => Promise<{
    id: number;
    node_id: string;
    name: string;
    full_name: string;
...
export declare const getUserRepositories: (username: string, search?: string, page?: number, perPage?: number) => Promise<{
    total_count: number;
    incomplete_results: boolean;
    items: import("@octokit/openapi-types").components["schemas"]["repo-search-result-item"][];
}>;
export declare const getRepositoryTree: (username: string, repo: string, branch?: string) => Promise<{
    sha: string;
    url?: string;
    truncated: boolean;
    tree: {
